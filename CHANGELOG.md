...
### Fixed
- Fixed permission-denied failures when staging modifications to read-only files on macOS by normalizing private clone permissions before opening them for writes.
