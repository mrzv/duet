...
- Bounded directory scanning globally to 64 concurrent reads and content hashing separately to eight concurrent files while preserving deterministic results.
